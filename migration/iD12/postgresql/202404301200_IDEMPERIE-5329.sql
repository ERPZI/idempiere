...
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,IsCentrallyMaintained,ColumnName,IsIdentifier,SeqNoSelection,IsMandatory,IsKey,IsReadOnly) VALUES (200231,0,0,'Y',TO_TIMESTAMP('2022-07-04 19:16:58','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2022-07-04 19:16:58','YYYY-MM-DD HH24:MI:SS'),100,'Bank Account','Account at the Bank','The Bank Account identifies an account at this Bank.',200020,'D','a.C_BankAccount_ID',30,'Y','N',836,19,'6f1fa8aa-551c-48b0-9b14-d04a1df6bae6','Y','C_BankAccount_ID','N',0,'N','N','Y')
;

-- 04-Jul-2022, 7:17:00 PM IST
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,IsCentrallyMaintained,ColumnName,QueryOperator,QueryFunction,IsIdentifier,SeqNoSelection,IsMandatory,IsKey,IsReadOnly) VALUES (200232,0,0,'Y',TO_TIMESTAMP('2022-07-04 19:16:59','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2022-07-04 19:16:59','YYYY-MM-DD HH24:MI:SS'),100,'Deposit Date',200020,'D','a.DateDeposit',40,'Y','Y',202197,15,'f9df0759-b0b4-4f97-b792-d738507d5bdd','Y','DateDeposit','=','Trunc','Y',10,'N','N','Y')
;

-- 04-Jul-2022, 7:17:00 PM IST
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,AD_Val_Rule_ID,IsCentrallyMaintained,ColumnName,IsIdentifier,SeqNoSelection,IsMandatory,IsKey,IsReadOnly) VALUES (200233,0,0,'Y',TO_TIMESTAMP('2022-07-04 19:17:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2022-07-04 19:17:00','YYYY-MM-DD HH24:MI:SS'),100,'Document Type','Document type or rules','The Document Type determines document sequence and processing rules',200020,'D','a.C_DocType_ID',50,'Y','N',196,19,'cfebd86d-1a33-40dd-899c-a61902785694',149,'Y','C_DocType_ID','N',0,'N','N','Y')
;
...
INSERT INTO AD_Message (MsgType,MsgText,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Message_ID,Value,EntityType,AD_Message_UU) VALUES ('E','Fail to get Payments Into Batch amount',0,0,'Y',TO_TIMESTAMP('2022-07-06 16:43:29','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2022-07-06 16:43:29','YYYY-MM-DD HH24:MI:SS'),100,200772,'MissingPaymentIntoBatch','D','78f49a7e-e646-48b8-a325-a834b1ba1ed1')
;
...
UPDATE AD_Column SET AD_Val_Rule_ID=130, ColumnName='AD_Org_ID', AD_Reference_Value_ID=NULL, AD_Process_ID=NULL, IsSyncDatabase='Y', AD_Chart_ID=NULL, PA_DashboardContent_ID=NULL, AD_Val_Rule_Lookup_ID=NULL,Updated=TO_TIMESTAMP('2023-02-08 18:32:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=208399
;


-- Adding C_DepositBatch_ID column on C_Payment_v view
-- Apr 30, 2024, 4:42:57 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,IsToolbarButton,IsSecure,FKConstraintType,IsHtml) VALUES (216591,0.0,'Deposit Batch',554,'C_DepositBatch_ID',10,'N','N','N','N','N','N',19,0,0,'Y',TO_TIMESTAMP('2024-04-30 16:42:57','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2024-04-30 16:42:57','YYYY-MM-DD HH24:MI:SS'),100,202195,'N','N','D','Y','N','N','Y','d7bec526-2235-40f0-90f0-306876842ca4','Y','N','N','N','N')
;
...
UPDATE C_DepositBatch SET C_Currency_ID = ba.C_Currency_ID FROM C_BankAccount ba WHERE ba.C_BankAccount_ID = C_DepositBatch.C_BankAccount_ID AND C_DepositBatch.C_Currency_ID IS NULL
;
...
INSERT INTO t_alter_column values('c_depositbatch','C_Currency_ID','NUMERIC(10)',null)
;

-- Apr 4, 2024, 6:01:49 PM IST
INSERT INTO t_alter_column values('c_depositbatch','C_Currency_ID',null,'NOT NULL')
;
